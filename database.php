...
class DATABASE_CONFIG {
	...
	function __construct() {
		...
		$this->default['login'] = getenv('MYSQL_ENV_MYSQL_USER');
		$this->default['password'] = getenv('MYSQL_ENV_MYSQL_PASSWORD');
		$this->default['database'] = getenv('MYSQL_ENV_MYSQL_DATABASE');
	}
}
